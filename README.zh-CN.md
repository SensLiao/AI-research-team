...
<p align="center"><img src="docs/evidence-chain.png" alt="一条引用如何被核验：带 SHA-256 记录的不可变快照、携带字符偏移与确切引文的位点，随后重新打开快照比对；旁边是哈希链账本" width="100%"></p>
<p align="center"><sub>一个位点只有通过重新打开快照并重新计算才算被核验——而记录运行的账本是链式且单写者的。</sub></p>
