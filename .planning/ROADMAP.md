# Roadmap: Research Agent Teams — AI Manuscript Authoring

## Overview

The accepted scope is one coherent vertical product capability: the director can take local, auditable evidence through frozen manuscript design, dependency-safe multi-agent writing, single-owner integration, native LaTeX generation, honest PDF build status, independent manuscript audits, and human-first submission evidence. Coarse granularity therefore yields one phase; architecture, implementation, review, and verification will be separated as plans or waves inside that phase rather than as thin follow-up phases.
...
- [x] **Phase 1: Operated AI Manuscript Authoring** - Delivered and verified on 2026-07-22: local-first operated authoring and separate advisory review capability from auditable evidence to LaTeX/PDF status and strict director-review evidence.
...
**Plans**: 20/20 plans executed and release-verified
...
|-------|----------------|--------|-----------|
| 1. Operated AI Manuscript Authoring | 20/20 | Complete | 2026-07-22 |

## Requirement Coverage

Every v1 requirement is assigned exactly once to Phase 1. There are no orphaned or duplicated phase assignments.

| Category | Requirement IDs | Count |
|----------|-----------------|------:|
| Operated Product | OPER-01–OPER-03 | 3 |
| Pre-Draft Contract | PREP-01–PREP-04 | 4 |
| Evidence Coverage | EVID-01–EVID-03 | 3 |
| Multi-Agent Authoring | ORCH-01–ORCH-02 | 2 |
| LaTeX and Assets | LATX-01–LATX-02, ASST-01 | 3 |
| Audit and Delivery | AUDT-01, DELV-01–DELV-02 | 3 |
| Safety and Platform Boundaries | SAFE-01–SAFE-03, PLAT-01–PLAT-02 | 5 |
| Verification Evidence | VERI-01–VERI-05 | 5 |
| **Total** |  | **28** |

---
*Roadmap created: 2026-07-21 from the approved locked scope*
