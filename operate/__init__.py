...
opaque `agent_fn`; that is the path the tests exercise with stub producers. But REAL workers are
Codex-harness sub-agents, which a Python `agent_fn` cannot spawn. The operate layer
