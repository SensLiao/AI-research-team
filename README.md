...
<!-- image-slot: docs/evidence-chain.png — how a claim is verified: immutable snapshot + SHA-256, character offsets, reopen-and-compare, BLOCK on mismatch; beside it the hash-chained ledger -->
