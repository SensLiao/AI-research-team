...
# 六、一个完整 AI Research Team 需要哪些"认知 agent"？

agent 不是固定职位，也不等于人数。一个人可以兼任两三个 agent；一个 agent 也可能由多个人共同承担。关键是：**每一种认知功能都必须有人明确守护。**

## A. 定义研究空间

| agent | 它守护的核心问题 | 应贡献的认知产物 | 思考姿态 |
| --- | --- | --- | --- |
...
一个研究团队不是观点越一致越好。真正健康的研究结构更像一个 **epistemic parliament，认识论议会**。不同 agent 守护不同形式的真理，并且彼此制衡。
